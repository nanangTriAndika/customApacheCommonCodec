...
public class Base64OutputStream extends BaseNCodecOutputStream {
    ...
    /**
     * Creates a Base64OutputStream such that all data written is ApacheBase64-encoded to the original provided OutputStream.
     *
     * @param out
    ...
    /**
     * Creates a Base64OutputStream such that all data written is either ApacheBase64-encoded or ApacheBase64-decoded to the
 original provided OutputStream.
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode) {
        super(out,new ApacheBase64(false), doEncode);
    }
 ...
 original provided OutputStream.
    ...
    public Base64OutputStream(final OutputStream out, final boolean doEncode,
        ...
        super(out, new ApacheBase64(lineLength, lineSeparator), doEncode);
    }
}
