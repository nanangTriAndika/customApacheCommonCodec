...
public class Base64InputStreamTest {
    ...
    public void testCodec130() throws IOException {
        ...
        ins.skip(1);
        final byte[] decodedBytes = ApacheBase64TestData.streamToBytes(ins, new byte[64]);
    ...
    public void testCodec101() throws Exception {
        final byte[] codec101 = StringUtils.getBytesUtf8(ApacheBase64TestData.CODEC_101_MULTIPLE_OF_3);
    ...
    public void testCodec98NPE() throws Exception {
        final byte[] codec98 = StringUtils.getBytesUtf8(ApacheBase64TestData.CODEC_98_NPE);
        ...
        final byte[] decodedBytes = ApacheBase64TestData.streamToBytes(stream, new byte[1024]);

        final String decoded = StringUtils.newStringUtf8(decodedBytes);
        assertEquals("codec-98 NPE Base64InputStream", ApacheBase64TestData.CODEC_98_NPE_DECODED, decoded);
    }
    ...
    public void testBase64InputStreamByChunk() throws Exception {
        ...
        encoded = StringUtils.getBytesUtf8(ApacheBase64TestData.ENCODED_64_CHARS_PER_LINE);
        decoded = ApacheBase64TestData.DECODED;
        testByChunk(encoded, decoded, BaseNCodec.PEM_CHUNK_SIZE, LF);

        // Single Line test.
        final String singleLine = ApacheBase64TestData.ENCODED_64_CHARS_PER_LINE.replaceAll("\n", "");
        ...
        for (int i = 0; i <= 150; i++) {
            final byte[][] randomData = ApacheBase64TestData.randomData(i, false);
    ...
    private void testByChunk(final byte[] encoded, final byte[] decoded, final int chunkSize, final byte[] separator) throws Exception {
        ...
        byte[] output = ApacheBase64TestData.streamToBytes(in);
        ...
        output = ApacheBase64TestData.streamToBytes(in);
